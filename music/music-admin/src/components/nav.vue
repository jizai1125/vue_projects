        ...
        <MenuItem class="opera-btn" name="1">
          <Dropdown trigger="click">
            ...
            <DropdownMenu slot="list">
              <DropdownItem @click.native="goIndex">你好,{{adminInfo.name}}</DropdownItem>
              <DropdownItem @click.native="goUserManage">用户管理</DropdownItem>
              <DropdownItem @click.native="goManageMusic">歌曲管理</DropdownItem>
              <DropdownItem @click.native="goAdminLikes">推荐歌曲管理</DropdownItem>
              <DropdownItem @click.native="goStyleManage">歌曲风格管理</DropdownItem>
...
export default {
  ...
  methods: {
    ...
    goStyleManage() {
      this.$router.push("/admin/styleManage");
    },
    goUserManage() {
      this.$router.push("/admin/userManage");
    },
    goManageMusic() {
      this.$router.push("/admin/musicManage");
    },
    goAdminLikes() {
